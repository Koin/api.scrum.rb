...
describe SprintsController do
  ...
  def valid_attributes
    { "start_date" => "2013-04-26 13:34:55" }
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sprint as @sprint" do
        ...
        post :create, {:sprint => { "start_date" => "invalid value" }}, valid_session
        assigns(:sprint).should be_a_new(Sprint)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sprint" do
        ...
        Sprint.any_instance.should_receive(:update).with({ "start_date" => "2013-04-26 13:34:55" })
        put :update, {:id => sprint.to_param, :sprint => { "start_date" => "2013-04-26 13:34:55" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sprint as @sprint" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sprint.any_instance.stub(:save).and_return(false)
        put :update, {:id => sprint.to_param, :sprint => { "start_date" => "invalid value" }}, valid_session
        assigns(:sprint).should eq(sprint)
      end
